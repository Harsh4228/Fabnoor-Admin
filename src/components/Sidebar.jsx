    ...
    <>
      ...
      <div className={`md:hidden fixed left-0 top-0 h-full w-72 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        <div className='p-6 border-b border-slate-100'>
          <p className='font-bold text-lg text-slate-800 tracking-tight'>Administration</p>
        </div>
      ...
      <aside className="hidden md:flex flex-col w-64 h-full bg-slate-900 text-slate-300 flex-shrink-0">
        <div className="flex flex-col gap-1 p-4 h-full">
          <div className='px-4 mb-6 mt-4'>
            <p className='text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em]'>Main Navigation</p>
          </div>
          ...
          <div className='mt-auto p-4 bg-slate-800/50 rounded-2xl'>
            <div className='flex items-center gap-3 mb-2'>
              ...
              <p className='text-xs font-semibold text-slate-400'>System Online</p>
            </div>
