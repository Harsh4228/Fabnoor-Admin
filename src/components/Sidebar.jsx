...
const ICONS = {
  ...
  trash:       "M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6M9.5 3h5a1 1 0 011 1v2h-7V4a1 1 0 011-1zM4 7h16",
};
...
const NAV = [
  ...
  { to: "/trash",           icon: ICONS.trash,      label: "Trash" },
];
