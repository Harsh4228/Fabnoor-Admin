...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile Sidebar */}
      <div className={`md:hidden fixed left-0 top-0 h-full w-72 bg-white shadow-2xl z-50 transform transition-transform duration-300 ease-in-out ${
        ...
        <div className='flex flex-col gap-3 p-5'>
          <NavLink 
            className={({ isActive }) => 
              `flex items-center gap-4 border border-gray-200 px-4 py-3.5 rounded-xl transition-all duration-300 group ${
                isActive 
      ...
      <div className="hidden md:block w-[18%] min-w-[240px] min-h-screen border-r-2 border-gray-200 bg-gradient-to-b from-gray-50 to-white shadow-sm">
        <div className="flex flex-col gap-4 pt-8 pl-[20%] pr-4 text-[15px] sticky top-20">
          ...
          <NavLink 
            className={({ isActive }) => 
              `flex items-center gap-3 border border-gray-300 border-r-0 px-4 py-3.5 rounded-l-xl transition-all duration-300 group relative overflow-hidden ${
                isActive 
                  ? 'bg-gradient-to-r from-gray-800 to-gray-700 text-white shadow-lg border-transparent' 
